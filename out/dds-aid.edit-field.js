...
function editField(context) {
    context.subscriptions.push(vscode.commands.registerCommand("dds-aid.edit-field", async (node) => {
        ...
        if (!newSize)
            return;
        const { length, decimals } = (0, dds_aid_helper_1.parseSize)(newSize);
...
;
//# sourceMappingURL=dds-aid.edit-field.js.map