...
- **Edit Constant** — change the constant's text.
- **Remove constant** — delete it from the record.
- **Copy Constant** — duplicate it, to the same record or a different one.
...
**Fill Constant** repeats a character across a run of positions — useful for separator lines and underscores.
